...
(  SELECT SFRSTCR_PIDM
  ...
  Insert into GLBSLCT
   (GLBSLCT_APPLICATION, GLBSLCT_SELECTION, GLBSLCT_CREATOR_ID, GLBSLCT_DESC, GLBSLCT_LOCK_IND, 
    GLBSLCT_ACTIVITY_DATE, GLBSLCT_TYPE_IND)
 Values
   ('STUDENT', 'COMP18', 'SAISUSR', '„ÿ«»ﬁ«  ', 'N', 
    SYSDATE, NULL);
 
 
Insert into GLBEXTR
   SELECT 'STUDENT', 'COMP18', 'SAISUSR', 'SAISUSR', SGBSTDN_PIDM, 
    SYSDATE, 'S', NULL  FROM 
(  SELECT A.SGBSTDN_PIDM  
    FROM SGBSTDN A 
   WHERE     SGBSTDN_TERM_CODE_EFF =
  ...
  AND A.SGBSTDN_STST_CODE NOT IN ('ŒÃ','„”','ÿ‰')
         ...
         AND A.SGBSTDN_PROGRAM_1 IN ('1F31PHYS38')
 )
  ;
  ...
  Insert into GLBSLCT
   (GLBSLCT_APPLICATION, GLBSLCT_SELECTION, GLBSLCT_CREATOR_ID, GLBSLCT_DESC, GLBSLCT_LOCK_IND, 
    GLBSLCT_ACTIVITY_DATE, GLBSLCT_TYPE_IND)
 Values
   ('STUDENT', 'COMP15', 'SAISUSR', '„ÿ«»ﬁ«  ', 'N', 
    SYSDATE, NULL);
 
 
Insert into GLBEXTR
   SELECT 'STUDENT', 'COMP15', 'SAISUSR', 'SAISUSR', SFRSTCR_PIDM, 
    SYSDATE, 'S', NULL  FROM 
(  SELECT SFRSTCR_PIDM
            FROM SFRSTCR
