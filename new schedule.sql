SELECT COUNT (*) OVER (PARTITION BY day) AS day_cnt,
           ...
           FROM (  SELECT day,
                          ...
                          scbcrse_title,
                          CASE
                             WHEN LAG (day) OVER (ORDER BY NULL) = day
                             THEN
                                NULL
                             ELSE
                                day
                     ...
                     FROM (SELECT sfrstcr_pidm,
                                  ...
                                  DECODE (ssrmeet.ssrmeet_sat_day, 'S', '1S')
                                     ssrmeet_sat_day,coalesce(ssrmeet.ssrmeet_sun_day,ssrmeet.ssrmeet_mon_day,ssrmeet.ssrmeet_tue_day,ssrmeet.ssrmeet_wed_day,ssrmeet.ssrmeet_thu_day,ssrmeet.ssrmeet_fri_day,ssrmeet.ssrmeet_sat_day,'9U') unknow_day,
                             ...
                             FROM sfrstcr,
                                  ...
                                  stvschd,
                                  slbrdef
                            WHERE     sfrstcr_pidm = f_get_pidm('437010404')
                                  AND sfrstcr_term_code = :hold_term
                                  ...
                                  AND slbrdef.slbrdef_room_number(+) =
                                         ssrmeet_room_code
