...
SELECT spbpers_pidm,
       ...
       f_get_std_name (spbpers_pidm)     std_name  ,APPLICANT_CHOICE_NO ,APPLICANT_CHOICE ,APPLICANT_RATE ,(SELECT MIN (APPLICANT_RATE)
                          FROM VW_APPLICANT_CHOICES
                         WHERE     ADMIT_TERM = '144510'
                               AND APPLICANT_DECISION = 'FA'
                               AND APPLICANT_CHOICE = :program_cd) minimum_rate
                 ...
                 WHERE bu_apps.f_get_applicant_rate ('144510',
                       ...
                       (SELECT MIN (APPLICANT_RATE)
                         ...
                         WHERE     ADMIT_TERM = '144510'
                               ...
                               CREATE PUBLIC SYNONYM f_get_applicant_rate FOR bu_apps.f_get_applicant_rate ; 
                               
                               grant EXECUTE on f_get_applicant_rate to RAZAHRANI ;