   ...
   IS
      SELECT sfrstcr_pidm,
       ...
       WHERE     sfrstcr_pidm = shrtckn_pidm(+)
             ...
             AND sfrstcr_term_code = '143830'
           --  AND sfrstcr_crn = '14912'
          -- and shrtckn.SHRTCKN_SUBJ_CODE='1502'
           --and shrtckn.shrtckn_crse_numb='1402'
           and sfrstcr_pidm=f_get_pidm('436009913') --
             ;
...
BEGIN
   ...
   LOOP
      ...
      BEGIN
         UPDATE sfrstcr
            SET sfrstcr_grde_date = NULL ,SFRSTCR_GRDE_CODE=null ,SFRSTCR_RSTS_CODE='DD'
