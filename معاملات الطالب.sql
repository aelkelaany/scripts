/* Formatted on 9/9/2020 11:45:49 AM (QP5 v5.360) */
-- requester
...
SELECT m1.request_no,
       ...
       r1.role_code,
       r1.action_code,
       to_char(TO_DATE(m1.request_date),'dd-mm-yyyy','nls_calendar=''Arabic Hijrah''')    request_date,
       m1.object_code
           object_code,
       ...
       f_get_std_id (r1.user_pidm) || '-' || f_get_std_name (r1.user_pidm)
           approver,
       to_char(TO_DATE(r1.ACTIVITY_DATE),'dd-mm-yyyy','nls_calendar=''Arabic Hijrah''')    activity_date ,r1.notes
