/* Formatted on 5/14/2020 6:01:41 PM (QP5 v5.227.12220.39754) */
SELECT  

       capp.subject_code || capp.course_number subject,

       capp.COURSE_TITLE ,(SELECT GREATEST (NVL (SCBCRSE_CREDIT_HR_LOW, 0),
                         ...
                         (SELECT MAX (scbcrse_eff_term)
                           ...
                           WHERE     scbcrse_subj_code =
                                 ...
                                 AND scbcrse_eff_term <=
                                        ...
                                        CAPP.EFFECTIVE_TERM)) subj_crd_hrs ,SPRIDEN_ID STUDENT_ID,
         ...
         F_GET_DESC_FNC ('STVMAJR', comp.MAJR_CODE, 60) MAJR_DESC ,capp.REQUIRED_FLAG 
            COMP.*
...
SELECT SMBPOGN_PIDM PIDM,                                        ------PROGRAM
 ...
 where SGBSTDN_PIDM = SMBPOGN_PIDM
      ...
      on CAPP.PROGRAM_CODE = COMP.PROGRAM_CODE
       ...
       where  PIDM = f_get_pidm('431007385')

       AND SPRIDEN_PIDM = comp.PIDM
