/* Formatted on 3/20/2019 12:01:24 PM (QP5 v5.227.12220.39754) */
-- Course Number | College Code | College Name| Department  Code | Department Name| College Dean ID | Vice Dean ID | Department Manager ID
SELECT * FROM SCBCRSE WHERE  SCBCRSE_SUBJ_CODE ||   SCBCRSE_CRSE_NUMB NOT IN 
(
SELECT "Course Number" FROM 
...
ORDER BY 3, 4, 1 ))
--WHERE "Course Title" LIKE '%ËÞÇÝÉ ÇÓáÇãíÉ%'